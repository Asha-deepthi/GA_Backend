# Generated by Django 5.2 on 2025-06-11 08:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0004_candidate_customuser_role'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_limit', models.CharField(blank=True, help_text='e.g., 00:00:00', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('INVITED', 'Invited'), ('STARTED', 'Started'), ('COMPLETED', 'Completed')], default='INVITED', max_length=20)),
                ('score', models.FloatField(blank=True, null=True)),
                ('date_invited', models.DateTimeField(auto_now_add=True)),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_assignments', to='users.candidate')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignments', to='test_creation.test')),
            ],
            options={
